...
{
    public class ModuleDataSetAdapter: DataSetAdapter<Module, int, ModuleMapping>
    {
        public ModuleDataSetAdapter()
            : base("Security")
        {
            
        }

        public ModuleDataSetAdapter(string connection_string_name)
